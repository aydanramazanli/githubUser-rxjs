...
export default function Details({url, name, company, bio,location,blog, username, html_url}) {
  return (
    <div
    ...
    >
      <header className="flex justify-between  items-center">
        <div className="flex items-center">
          <img src={url} alt={name} className="w-20 h-20 rounded-3xl" />
          <div className="mx-5">
      ...
      <main>
        ...
        <p className="flex my-3">
          <MdLocationOn className="text-xl mr-1 text-cyan-800" />{" "}
          {location || " not find location"}
        </p>
